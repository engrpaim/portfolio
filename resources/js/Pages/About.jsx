                        ...
                        <div className="flex flex-wrap items-center justify-center h-20 text-center bg-gray-200 shadow-lg h-min-fit w-60 md:w-20 md:h-80 md:block drop-shadow-xl">
                            <div className="p-0.5  md:hover:bg-blue-200 h-1/3 md:hover:scale-110 hover:md:drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]">
                                <a href="https://linkedin.com/in/jose-ephraim-batacan-51a35524a" target="_blank" >
                                    <svg id="LGlinked" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" className="w-20 h-20 mt-4 md:m-5 md:mt-8 fill-blue-900 md:fill-black md:hover:fill-blue-900">
                            ...
                            <div className="p-0.5 md:fill-none  md:hover:bg-yellow-200 h-1/3 md:hover:scale-110 md:hover:drop-shadow-[5px_35px_35px_rgba(0,0,0,0.25)]">
                                <a href="https://github.com/engrpaim" target="_blank" >
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-20 h-20 mt-5 mr-10 fill-yellow-600 md:fill-gray-800 md:m-6 md:mt-9 md:hover:fill-yellow-700" fill="currentColor"  viewBox="0 0 30 30">
                                        <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8"/>
                                    </svg>
                                </a>
                            </div>
                            <div className="p-0.5 md:hover:bg-red-200 items-center mb-48 md:mb-0 h-1/3 md:hover:scale-110 md:hover:drop-shadow-[5px_35px_35px_rgba(0,0,0,0.25)]">
                                <a href="mailto:joseephraimbatacan@gmail.com" target="_blank" >
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-20 ml-40 md:mb-20 fill-red-800 md:fill-gray-800 md:m-6 md:mt-10 md:hover:fill-red-700" viewBox="0 -320 960 960"  fill="currentColor">
